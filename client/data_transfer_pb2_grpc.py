...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in data_transfer_pb2_grpc.py depends on'
...
class DataTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendData = channel.unary_unary(
                '/datatransfer.DataTransfer/SendData',
                request_serializer=data__transfer__pb2.SendDataRequest.SerializeToString,
...
def add_DataTransferServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendData,
                    request_deserializer=data__transfer__pb2.SendDataRequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'datatransfer.DataTransfer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('datatransfer.DataTransfer', rpc_method_handlers)
...
class DataTransfer(object):
    ...
    def SendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/datatransfer.DataTransfer/SendData',
            data__transfer__pb2.SendDataRequest.SerializeToString,
